defmodule FSModEvent.Connection do
  ...
  def sendmsg_exec(name, uuid, command, args \\ "", event_uuid \\ nil, loops \\ 1, body \\ "") do
    sendmsg(
      name,
      uuid,
      "execute",
  ...
  def handle_call(call, _from, state) do
    Logger.warning("Unknown call: #{inspect(call)}")
  ...
  def handle_cast(cast, state) do
    Logger.warning("Unknown cast: #{inspect(cast)}")
    {:noreply, state}
  end
