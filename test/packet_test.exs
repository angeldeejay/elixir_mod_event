defmodule FSModEvent.Test.Packet do
  ...
  test "can parse multiple" do
    {~c"", pkts} = Packet.parse(read!("3.txt"))
  ...
  test "can parse custom data" do
    ...
    assert p.custom_payload === ~c"this is a custom payload this is a custom payload oh yeah"
  end
